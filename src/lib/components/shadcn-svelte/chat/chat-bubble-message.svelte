<script lang="ts">
	import LoadingDots from "$lib/components/shadcn-svelte/chat/loading-dots.svelte";
	import type { ChatBubbleMessageProps } from "$lib/components/shadcn-svelte/chat/types";
