...
export type ChatListProps = ChatListPropsWithoutHTML & WithoutChildren<HTMLAttributes<HTMLDivElement>>;
...
export type ChatBubbleProps = ChatBubblePropsWithoutHTML & WithoutChildren<HTMLAttributes<HTMLDivElement>>;
