<script lang="ts">
	import { usePasswordToggleVisibility } from "$lib/components/shadcn-svelte/password/password.svelte.js";
	import type { PasswordToggleVisibilityProps } from "$lib/components/shadcn-svelte/password/types.js";
	import { Toggle } from "$lib/components/shadcn-svelte/toggle";
