<script lang="ts">
	import { usePasswordStrength } from "$lib/components/shadcn-svelte/password/password.svelte.js";
	import type { PasswordStrengthProps } from "$lib/components/shadcn-svelte/password/types.js";
