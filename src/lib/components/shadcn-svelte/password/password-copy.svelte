<script lang="ts">
	...
	import { usePasswordCopy } from "$lib/components/shadcn-svelte/password/password.svelte.js";
	import type { PasswordCopyButtonProps } from "$lib/components/shadcn-svelte/password/types.js";
