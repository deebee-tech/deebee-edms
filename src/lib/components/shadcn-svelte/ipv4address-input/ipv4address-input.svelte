<script lang="ts">
	import { safeParseIPv4Address } from "$lib/components/shadcn-svelte/ipv4address-input";
	import Input from "$lib/components/shadcn-svelte/ipv4address-input/ipv4address-input-input.svelte";
	import type { IPv4AddressInputProps } from "$lib/components/shadcn-svelte/ipv4address-input/types";
