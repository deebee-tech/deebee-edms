<script lang="ts">
	import { useFileDropZone } from "$lib/components/shadcn-svelte/file-drop-zone/file-drop-zone.svelte.js";
	import type { FileDropZoneRootProps } from "$lib/components/shadcn-svelte/file-drop-zone/types.js";
