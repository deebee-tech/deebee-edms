<script lang="ts">
	import { useFileDropZoneTrigger } from "$lib/components/shadcn-svelte/file-drop-zone/file-drop-zone.svelte.js";
	import { displaySize } from "$lib/components/shadcn-svelte/file-drop-zone/index.js";
	import type { FileDropZoneTriggerProps } from "$lib/components/shadcn-svelte/file-drop-zone/types.js";
