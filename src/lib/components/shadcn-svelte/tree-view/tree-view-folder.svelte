<script lang="ts">
	import * as Collapsible from "$lib/components/shadcn-svelte/collapsible/index.js";
	import type { TreeViewFolderProps } from "$lib/components/shadcn-svelte/tree-view/types";
