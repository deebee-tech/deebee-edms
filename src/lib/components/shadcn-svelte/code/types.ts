import type { CodeVariant } from "$lib/components/shadcn-svelte/code";
import type { SupportedLanguage } from "$lib/components/shadcn-svelte/code/shiki";
import type { CopyButtonPropsWithoutHTML } from "$lib/components/shadcn-svelte/copy-button/types";
