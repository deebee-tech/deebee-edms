<script lang="ts">
	import { codeVariants } from "$lib/components/shadcn-svelte/code";
	import { useCode } from "$lib/components/shadcn-svelte/code/code.svelte.js";
	import type { CodeRootProps } from "$lib/components/shadcn-svelte/code/types";
