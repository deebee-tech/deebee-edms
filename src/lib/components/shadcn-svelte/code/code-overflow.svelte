<script lang="ts">
	...
	import { useCodeOverflow } from "$lib/components/shadcn-svelte/code/code.svelte.js";
	import type { CodeOverflowProps } from "$lib/components/shadcn-svelte/code/types";
