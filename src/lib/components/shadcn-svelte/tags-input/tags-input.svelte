<script lang="ts">
	import TagsInputSuggestion from "$lib/components/shadcn-svelte/tags-input/tags-input-suggestion.svelte";
	import TagsInputTag from "$lib/components/shadcn-svelte/tags-input/tags-input-tag.svelte";
	import type { TagsInputProps } from "$lib/components/shadcn-svelte/tags-input/types";
