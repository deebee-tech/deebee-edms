...
import type { Command as CommandPrimitive, WithChildren, WithoutChild, WithoutChildren } from "bits-ui";
...
export type EmojiPickerSkinProps = EmojiPickerSkinPropsWithoutHTML & WithoutChildren<ButtonElementProps>;
