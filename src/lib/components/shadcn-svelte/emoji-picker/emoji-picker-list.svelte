<script lang="ts">
	...
	import {
		...
		parseValue,
		useEmojiPickerList,
	} from "$lib/components/shadcn-svelte/emoji-picker/emoji-picker.svelte.js";
	import type { EmojiPickerListProps } from "$lib/components/shadcn-svelte/emoji-picker/types";
