<script lang="ts">
	import { useEmojiPickerInput } from "$lib/components/shadcn-svelte/emoji-picker/emoji-picker.svelte.js";
	import type { EmojiPickerSearchProps } from "$lib/components/shadcn-svelte/emoji-picker/types";
