...
<script lang="ts">
	import { type PhoneInputProps } from "$lib/components/shadcn-svelte/phone-input";
	import CountrySelector from "$lib/components/shadcn-svelte/phone-input/country-selector.svelte";
