<script lang="ts">
	...
	import type { EmojiPickerListProps } from "$lib/components/ui/emoji-picker/types";
	import { makeValue, parseValue, useEmojiPickerList } from "$lib/components/ui/emoji-picker/emoji-picker.svelte.js";
