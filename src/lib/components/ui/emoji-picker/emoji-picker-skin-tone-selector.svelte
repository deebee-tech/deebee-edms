<script lang="ts">
	...
	import { useEmojiPickerSkinToneSelector } from "$lib/components/ui/emoji-picker/emoji-picker.svelte.js";
	import type { EmojiPickerSkinProps } from "$lib/components/ui/emoji-picker/types.js";
