<script lang="ts">
	import type { EmojiPickerFooterProps } from "$lib/components/ui/emoji-picker/types";
	import { useEmojiPickerFooter } from "$lib/components/ui/emoji-picker/emoji-picker.svelte.js";
