<script lang="ts">
	...
	import { useImageCropperDialog } from "$lib/components/ui/image-cropper/image-cropper.svelte.js";
	import type { ImageCropperDialogProps } from "$lib/components/ui/image-cropper/types";
