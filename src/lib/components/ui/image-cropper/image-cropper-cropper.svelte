<script lang="ts">
	...
	import { useImageCropperCropper } from "$lib/components/ui/image-cropper/image-cropper.svelte.js";
	import type { ImageCropperCropperProps } from "$lib/components/ui/image-cropper/types.js";
