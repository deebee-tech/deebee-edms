<script lang="ts">
	...
	import { useImageCropperRoot } from "$lib/components/ui/image-cropper/image-cropper.svelte.js";
	import type { ImageCropperRootProps } from "$lib/components/ui/image-cropper/types";
